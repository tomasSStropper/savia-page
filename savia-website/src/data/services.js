export const services = [
  {
    ...
    items: [
      ...
      "Revisión de normativa ambiental vigente"
    ],
    itemsEN: [
      "Carbon footprint audit",
      "Life cycle analysis",
      "Solid waste diagnosis",
      "Water resources evaluation",
      "Current environmental regulation review"
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    items: [
      ...
      "ISO 14001:2015",
      "Esencial Costa Rica",
      "Carbono Neutralidad (INTE B5)",
      "LEED y certificaciones verdes"
    ],
    itemsEN: [
      "Blue Flag Ecological Program",
      "ISO 14001:2015",
      "Essential Costa Rica",
      "Carbon Neutrality (INTE B5)",
